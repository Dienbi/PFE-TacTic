...
|------|-------------|---------------------|
| `release1/use-case.puml` | Release 1 use case diagram (Sprint 1 \& 2) | `images/release1 use case.jpg` |
...
| File | Description | Report image target |
|------|-------------|---------------------|
| `release2/use-case.puml` | Release 2 use case diagram (Sprint 3 \& 4) | `images/release2 use case.jpg` |
...
The `sprint3/` folder contains the original Sprint 3 diagrams. Equivalent files also exist under `release2/`.
...
cd UML
java -jar plantuml.jar -tpng release1/*.puml release2/*.puml
...
Copy or rename generated PNG files into `Report/images/` to match the paths in `chap_03.tex` and `chap_04.tex`.
