...
export const payrollTourConfig: ScreenTour[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        target: '[data-tour="correction-create"]',
        title: 'Create correction',
        content: 'Select a validated payslip and click here to create a corrected version. This generates a **new version** of the payslip.',
        placement: 'bottom',
      },
      {
        target: '[data-tour="correction-superseded"]',
        title: 'Superseded marking',
        content: 'The original payslip is automatically marked as **Superseded** and kept for record-keeping — it\'s no longer active but stays visible in the history.',
        placement: 'right',
      },
      {
        target: '[data-tour="correction-version-history"]',
        title: 'Version history',
        content: 'Here you can view the full version history of a payslip: every correction, who made it, and when.',
        placement: 'bottom',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Payment date',
        content: 'Enter the date the payment was made to the employee.',
        placement: 'bottom',
      },
      {
      ...
      },
      {
        ...
        content: 'Payments are linked to a specific payslip so you always know what was paid for.',
        placement: 'bottom',
      },
    ],
  },
